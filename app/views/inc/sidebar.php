...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark  sidebar collapse" style="height: 100%;">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active sidebarhyper" style="color:white;" aria-current="page" href="#">
          ...
          <li class="nav-item">
            <a class="nav-link " style="color:white;" href="<?php echo URLROOT . 'pages/clients'; ?>">
          ...
          <li class="nav-item">
            <a class="nav-link" style="color:white;" href="<?php echo URLROOT . 'pages/message'; ?>">
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo URLROOT . 'pages/viewusers'; ?>" style="color:white;">
