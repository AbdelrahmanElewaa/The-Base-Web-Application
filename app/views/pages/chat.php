...
// print(date("h:i:sa A"));
    ...
    for($x=0;$x<count($allclients);$x++)
    {
        ...
        $clientids[$x]=$allclients[$x]->sender;
  ...
  else if($_SESSION['user_id']==1)   /////////////Admin//////////////
{
 ...
 <style>
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card chat-app" >
                <div id="plist" class="people-list"  style="position:relative">
                    <div class="input-group" >
                        <div class="input-group-prepend">
                        </div>
                        <input type="text" class="form-control" placeholder="Search...">
                    ...
                    <ul class="list-unstyled chat-list mt-2 mb-0"  style="position:absolute">
