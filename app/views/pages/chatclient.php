...
class chatclient extends View
{
  public function output()
  {
    ...
    {
    $action = URLROOT . 'pages/chatclient?id='.$_GET["id"].'& selected='.$_GET["selected"];
    }
    else{
        $action = URLROOT . 'pages/chatclient?id=$ selected=';   
    }
...
$sidee[$x]=<<<EOT
                    <a style="color:black;" href="http://localhost/mvc/public/pages/chatclient?id=$clientids[$x] & selected=$x">
                    <li  class="clearfix">
                    <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="avatar">
                    <div class="about">
