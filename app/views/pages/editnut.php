...
class editnut extends view {
   ...
   if(isset($_GET['id']))
   {
	 ...
	 $action = URLROOT . 'pages/editnut?id='.$_GET['id'];
   }
...
<!-- <form action="" method="post"> -->
  <html>
	...
	<hr>
  <input  style="width:200px;" class="form-control" type="date" id="birthday" name="date" value="<?php echo $nutrition->date; ?>" require><br>
...
<td><b>Breakfast</b></td>
 <td> <textarea  class="form-control" placeholder="Meal Name" name="bname" rows="4" cols="20" ><?php echo $nutrition->breakfast; ?></textarea> <p id="v_bname"></p></td>
 <td> <textarea  class="form-control" placeholder="Meal Name" name="bd" rows="4" cols="20" > <?php echo $nutrition->bd; ?></textarea><p id="v_bd"></p></td>
  </tr>
  <tr>
  
  <td><b>Lunch</b></td>
   <td> <textarea  class="form-control" placeholder="Meal Name" name="lname" rows="4" cols="20"> <?php echo $nutrition->lunch; ?></textarea><p id="v_lname"></p> </td>
   <td> <textarea  class="form-control" placeholder="Meal Name" name="ld" rows="4" cols="20" ><?php echo $nutrition->ld; ?> </textarea><p id="v_ld"></p></td>
    </tr>
    <tr>
  
  <td><b>Dinner</b></td>
   <td> <textarea  class="form-control" placeholder="Meal Name" name="dname" rows="4" cols="20"><?php echo $nutrition->dinner; ?></textarea><p id="v_dname"> </p></td>
   <td> <textarea  class="form-control" placeholder="Meal Name" name="dd" rows="4" cols="20" ><?php echo $nutrition->dd; ?> </textarea><p id="v_dd"></p></td>
    </tr>
